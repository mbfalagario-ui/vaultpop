...
const scenes = [
  {
    file: "splash.svg",
    title: "VaultPop",
    subtitle: "Fast-loading arcade start",
    bullets: ["Launches straight into play", "No network call before play", "Premium neon arcade"]
  },
  {
    file: "home.svg",
    title: "VaultPop",
...
function renderScene(scene) {
  ...
  <text x="58" y="146" fill="#43D9FF" font-family="Arial" font-size="13" font-weight="800">VAULTPOP ARCADE PUZZLE</text>
