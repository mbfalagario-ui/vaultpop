...
public protocol HybridRnIapSpec_protocol: HybridObject {
  ...
  func addSubscriptionBillingIssueListener(listener: @escaping (_ purchase: NitroPurchase) -> Void) throws -> Void
  func removeSubscriptionBillingIssueListener(listener: @escaping (_ purchase: NitroPurchase) -> Void) throws -> Void
