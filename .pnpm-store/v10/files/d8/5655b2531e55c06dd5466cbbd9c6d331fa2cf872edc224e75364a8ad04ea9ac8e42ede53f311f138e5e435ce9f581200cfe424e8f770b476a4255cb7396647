...
open class HybridRnIapSpec_cxx {
  ...
  @inline(__always)
  public final func getAllTransactionsIOS() -> bridge.Result_std__shared_ptr_Promise_std__vector_NitroPurchase____ {
    do {
      let __result = try self.__implementation.getAllTransactionsIOS()
      let __resultCpp = { () -> bridge.std__shared_ptr_Promise_std__vector_NitroPurchase___ in
        let __promise = bridge.create_std__shared_ptr_Promise_std__vector_NitroPurchase___()
        let __promiseHolder = bridge.wrap_std__shared_ptr_Promise_std__vector_NitroPurchase___(__promise)
        __result
  ...
  @inline(__always)
  public final func addSubscriptionBillingIssueListener(listener: bridge.Func_void_NitroPurchase) -> bridge.Result_void_ {
    do {
      try self.__implementation.addSubscriptionBillingIssueListener(listener: { () -> (NitroPurchase) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_NitroPurchase(listener)
        return { (__purchase: NitroPurchase) -> Void in
          __wrappedFunction.call(__purchase)
        }
  ...
  @inline(__always)
  public final func removeSubscriptionBillingIssueListener(listener: bridge.Func_void_NitroPurchase) -> bridge.Result_void_ {
    do {
      try self.__implementation.removeSubscriptionBillingIssueListener(listener: { () -> (NitroPurchase) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_NitroPurchase(listener)
        return { (__purchase: NitroPurchase) -> Void in
          __wrappedFunction.call(__purchase)
        }
