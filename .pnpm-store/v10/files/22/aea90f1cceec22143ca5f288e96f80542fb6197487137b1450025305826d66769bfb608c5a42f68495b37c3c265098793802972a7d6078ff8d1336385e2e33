...
abstract class HybridRnIapSpec: HybridObject() {
  ...
  @DoNotStrip
  @Keep
  abstract fun getAllTransactionsIOS(): Promise<Array<NitroPurchase>>
  ...
  abstract fun addSubscriptionBillingIssueListener(listener: (purchase: NitroPurchase) -> Unit): Unit
  
  @DoNotStrip
  @Keep
  private fun addSubscriptionBillingIssueListener_cxx(listener: Func_void_NitroPurchase): Unit {
    val __result = addSubscriptionBillingIssueListener(listener)
    return __result
  }
  
  abstract fun removeSubscriptionBillingIssueListener(listener: (purchase: NitroPurchase) -> Unit): Unit
  
  @DoNotStrip
  @Keep
  private fun removeSubscriptionBillingIssueListener_cxx(listener: Func_void_NitroPurchase): Unit {
    val __result = removeSubscriptionBillingIssueListener(listener)
    return __result
  }
