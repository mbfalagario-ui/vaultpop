...
export declare class AdvancedCommerceSubscriptionMigrateRequestValidator implements Validator<AdvancedCommerceSubscriptionMigrateRequest> {
    static readonly requestInfoValidator: AdvancedCommerceRequestInfoValidator;
    static readonly descriptorsValidator: AdvancedCommerceSubscriptionMigrateDescriptorsValidator;
    static readonly itemValidator: AdvancedCommerceSubscriptionMigrateItemValidator;
    static readonly renewalItemValidator: AdvancedCommerceSubscriptionMigrateRenewalItemValidator;
