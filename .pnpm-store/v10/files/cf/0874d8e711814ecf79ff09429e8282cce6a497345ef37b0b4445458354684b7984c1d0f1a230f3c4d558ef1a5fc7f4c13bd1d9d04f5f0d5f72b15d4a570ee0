...
import { DefaultConfigurationResponse } from './models/DefaultConfigurationResponse';
...
import { PerformanceTestResponse } from './models/PerformanceTestResponse';
import { PerformanceTestResultResponse } from './models/PerformanceTestResultResponse';
...
import { RealtimeUrlResponse } from './models/RealtimeUrlResponse';
...
export declare class AppStoreServerAPIClient {
     ...
     */
    getAllSubscriptionStatuses(anyTransactionId: string, status?: Status[] | undefined): Promise<StatusResponse>;
    /**
     ...
     */
    getRefundHistory(anyTransactionId: string, revision: string | null): Promise<RefundHistoryResponse>;
    /**
     ...
     */
    getTransactionHistory(anyTransactionId: string, revision: string | null, transactionHistoryRequest: TransactionHistoryRequest, version?: GetTransactionHistoryVersion): Promise<HistoryResponse>;
    /**
     ...
     */
    sendConsumptionData(transactionId: string, consumptionRequest: ConsumptionRequestV1): Promise<void>;
    /**
     ...
     */
    sendConsumptionInformation(transactionId: string, consumptionRequest: ConsumptionRequest): Promise<void>;
    /**
     ...
     */
    uploadImage(imageIdentifier: string, image: Buffer, imageSize?: string): Promise<void>;
    /**
     ...
     */
    getDefaultMessage(productId: string, locale: string): Promise<DefaultConfigurationResponse>;
    /**
     ...
     */
    configureRealtimeURL(realtimeUrlRequest: RealtimeUrlRequest): Promise<void>;
    /**
     ...
     */
    deleteRealtimeURL(): Promise<void>;
    /**
     ...
     */
    getRealtimeURL(): Promise<RealtimeUrlResponse>;
    /**
     ...
     */
    initiatePerformanceTest(performanceTestRequest: PerformanceTestRequest): Promise<PerformanceTestResponse>;
    /**
     ...
     */
    getPerformanceTestResults(requestId: string): Promise<PerformanceTestResultResponse>;
    /**
      ...
      */
    getAppTransactionInfo(anyTransactionId: string): Promise<AppTransactionInfoResponse>;
    /**
