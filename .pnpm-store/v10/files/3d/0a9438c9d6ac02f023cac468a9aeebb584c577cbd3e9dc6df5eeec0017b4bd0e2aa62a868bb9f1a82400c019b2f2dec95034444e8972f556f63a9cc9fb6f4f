...
namespace margelo::nitro::iap {
  ...
  public:
    ...
    PurchaseIOS toCpp() const {
      ...
      static const auto fieldAdvancedCommerceInfoIOS = clazz->getField<JVariant_NullType_AdvancedCommerceInfoIOS>("advancedCommerceInfoIOS");
      jni::local_ref<JVariant_NullType_AdvancedCommerceInfoIOS> advancedCommerceInfoIOS = this->getFieldValue(fieldAdvancedCommerceInfoIOS);
      ...
      return PurchaseIOS(
        advancedCommerceInfoIOS != nullptr ? std::make_optional(advancedCommerceInfoIOS->toCpp()) : std::nullopt,
