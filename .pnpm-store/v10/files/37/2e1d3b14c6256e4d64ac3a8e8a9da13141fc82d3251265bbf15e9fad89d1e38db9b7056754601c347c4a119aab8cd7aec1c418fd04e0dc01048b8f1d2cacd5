...
namespace margelo::nitro::iap::bridge::swift {
  ...
  // pragma MARK: std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>
  /**
   * Wrapper struct for `std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>`.
   * std::variant cannot be used in Swift because of a Swift bug.
   * Not even specializing it works. So we create a wrapper struct.
   */
  struct std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS_ final {
    std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS> variant;
    std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS_(std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS> variant): variant(variant) { }
    operator std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>() const noexcept {
      return variant;
    }
    inline size_t index() const noexcept {
      return variant.index();
    ...
    inline AdvancedCommerceItemDetailsIOS get_1() const noexcept {
      return std::get<1>(variant);
    }
  };
  inline std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS_ create_std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS_(nitro::NullType value) noexcept {
    return std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS_(value);
  }
  inline std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS_ create_std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS_(const AdvancedCommerceItemDetailsIOS& value) noexcept {
    return std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS_(value);
  }
  
  // pragma MARK: std::optional<std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>>
  /**
   * Specialized version of `std::optional<std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>>`.
   */
  using std__optional_std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS__ = std::optional<std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>>;
  inline std::optional<std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>> create_std__optional_std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS__(const std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>& value) noexcept {
    return std::optional<std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>>(value);
  }
  inline bool has_value_std__optional_std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS__(const std::optional<std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>>& optional) noexcept {
    return optional.has_value();
  }
  inline std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS> get_std__optional_std__variant_nitro__NullType__AdvancedCommerceItemDetailsIOS__(const std::optional<std::variant<nitro::NullType, AdvancedCommerceItemDetailsIOS>>& optional) noexcept {
    return optional.value();
  }
  
  // pragma MARK: std::vector<AdvancedCommerceRefundIOS>
  /**
   * Specialized version of `std::vector<AdvancedCommerceRefundIOS>`.
   */
  using std__vector_AdvancedCommerceRefundIOS_ = std::vector<AdvancedCommerceRefundIOS>;
  inline std::vector<AdvancedCommerceRefundIOS> create_std__vector_AdvancedCommerceRefundIOS_(size_t size) noexcept {
    std::vector<AdvancedCommerceRefundIOS> vector;
    vector.reserve(size);
    return vector;
  }
  
  // pragma MARK: std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>
  /**
   * Wrapper struct for `std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>`.
   * std::variant cannot be used in Swift because of a Swift bug.
   * Not even specializing it works. So we create a wrapper struct.
   */
  struct std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS__ final {
    std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>> variant;
    std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS__(std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>> variant): variant(variant) { }
    operator std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>() const noexcept {
      return variant;
    }
    inline size_t index() const noexcept {
      return variant.index();
    ...
    inline std::vector<AdvancedCommerceRefundIOS> get_1() const noexcept {
      return std::get<1>(variant);
    }
  };
  inline std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS__ create_std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS__(nitro::NullType value) noexcept {
    return std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS__(value);
  }
  inline std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS__ create_std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS__(const std::vector<AdvancedCommerceRefundIOS>& value) noexcept {
    return std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS__(value);
  }
  
  // pragma MARK: std::optional<std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>>
  /**
   * Specialized version of `std::optional<std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>>`.
   */
  using std__optional_std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS___ = std::optional<std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>>;
  inline std::optional<std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>> create_std__optional_std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS___(const std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>& value) noexcept {
    return std::optional<std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>>(value);
  }
  inline bool has_value_std__optional_std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS___(const std::optional<std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>>& optional) noexcept {
    return optional.has_value();
  }
  inline std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>> get_std__optional_std__variant_nitro__NullType__std__vector_AdvancedCommerceRefundIOS___(const std::optional<std::variant<nitro::NullType, std::vector<AdvancedCommerceRefundIOS>>>& optional) noexcept {
    return optional.value();
  }
  
  // pragma MARK: std::vector<AdvancedCommerceItemIOS>
  /**
   * Specialized version of `std::vector<AdvancedCommerceItemIOS>`.
   */
  using std__vector_AdvancedCommerceItemIOS_ = std::vector<AdvancedCommerceItemIOS>;
  inline std::vector<AdvancedCommerceItemIOS> create_std__vector_AdvancedCommerceItemIOS_(size_t size) noexcept {
    std::vector<AdvancedCommerceItemIOS> vector;
    vector.reserve(size);
    return vector;
  }
   ...
   * Not even specializing it works. So we create a wrapper struct.
   */
  struct std__variant_nitro__NullType__AdvancedCommerceInfoIOS_ final {
    std::variant<nitro::NullType, AdvancedCommerceInfoIOS> variant;
    std__variant_nitro__NullType__AdvancedCommerceInfoIOS_(std::variant<nitro::NullType, AdvancedCommerceInfoIOS> variant): variant(variant) { }
    operator std::variant<nitro::NullType, AdvancedCommerceInfoIOS>() const noexcept {
      return variant;
    }
    inline size_t index() const noexcept {
      return variant.index();
    ...
    inline AdvancedCommerceInfoIOS get_1() const noexcept {
      return std::get<1>(variant);
    }
  };
  inline std__variant_nitro__NullType__AdvancedCommerceInfoIOS_ create_std__variant_nitro__NullType__AdvancedCommerceInfoIOS_(nitro::NullType value) noexcept {
    return std__variant_nitro__NullType__AdvancedCommerceInfoIOS_(value);
  }
  inline std__variant_nitro__NullType__AdvancedCommerceInfoIOS_ create_std__variant_nitro__NullType__AdvancedCommerceInfoIOS_(const AdvancedCommerceInfoIOS& value) noexcept {
    return std__variant_nitro__NullType__AdvancedCommerceInfoIOS_(value);
  }
  
  // pragma MARK: std::optional<std::variant<nitro::NullType, AdvancedCommerceInfoIOS>>
  /**
   * Specialized version of `std::optional<std::variant<nitro::NullType, AdvancedCommerceInfoIOS>>`.
   */
  using std__optional_std__variant_nitro__NullType__AdvancedCommerceInfoIOS__ = std::optional<std::variant<nitro::NullType, AdvancedCommerceInfoIOS>>;
  inline std::optional<std::variant<nitro::NullType, AdvancedCommerceInfoIOS>> create_std__optional_std__variant_nitro__NullType__AdvancedCommerceInfoIOS__(const std::variant<nitro::NullType, AdvancedCommerceInfoIOS>& value) noexcept {
    return std::optional<std::variant<nitro::NullType, AdvancedCommerceInfoIOS>>(value);
  }
  inline bool has_value_std__optional_std__variant_nitro__NullType__AdvancedCommerceInfoIOS__(const std::optional<std::variant<nitro::NullType, AdvancedCommerceInfoIOS>>& optional) noexcept {
    return optional.has_value();
  }
  inline std::variant<nitro::NullType, AdvancedCommerceInfoIOS> get_std__optional_std__variant_nitro__NullType__AdvancedCommerceInfoIOS__(const std::optional<std::variant<nitro::NullType, AdvancedCommerceInfoIOS>>& optional) noexcept {
    return optional.value();
  }
