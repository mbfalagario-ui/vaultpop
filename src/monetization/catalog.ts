...
export const IAP_PRODUCTS = [
  ...
  },
  {
    ...
    description: "Adds 1,000 Vault Coins to use on in-game boosters and cosmetic unlocks.",
    kind: "consumable",
  ...
  },
  {
    ...
    description: "Adds 5,500 Vault Coins to use on in-game boosters and cosmetic unlocks.",
    kind: "consumable",
  ...
  },
  {
    ...
    description: "Adds 12,000 Vault Coins to use on in-game boosters and cosmetic unlocks.",
    kind: "consumable",
